        ...
        <div class="welcome">
            ...
            <div class="id_big-logo">
                <form action ="" class="welcome-form">
                    <input type="text" placeholder="Username_" class="welcome-input"/>
                    <input type="password" placeholder="Password_" class="welcome-input"/>
                    <submit class="btn id_welcome-btn welcome-input" value="Login">Login</submit>
                <p>New to community, <a href="#">Sign Up</a> instead</p>
                </form>
